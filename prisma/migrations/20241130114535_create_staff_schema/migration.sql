...
-- AlterTable
ALTER TABLE "staff"."users" ADD COLUMN     "permissions" "staff"."Permissions"[] DEFAULT ARRAY['USER_READ_SELF']::"staff"."Permissions"[],
ADD COLUMN     "role" "staff"."Roles" NOT NULL DEFAULT 'EMPLOYEE',
ADD COLUMN     "status" "staff"."Status" NOT NULL DEFAULT 'INACTIVE';
